...
export const shadow: Shadows = {
  ...
  navigation: { value: makeBoxShadow(0, 7, 11, gray100.setA(0.8).RGBA) },
  image: { value: makeBoxShadow(0, 2, 8, gray20.setA(0.5).RGBA) },
  large: { value: makeBoxShadow(0, 10, 29, gray80.setA(0.66).RGBA) },
  inverse: { value: makeBoxShadow(0, 6, 8, gray100.setA(0.88).RGBA) },
};
