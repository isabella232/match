...
**Note:** the order of the padding and margin props effects the generated CSS, learn more in the <Anchor href="#padding-and-margins"> padding and margin example</Anchor> below.
...
**The order of the padding and margin props will effect the padding and margins for the card!**
