...
To use the default design tokens, add an import in the file where you want to use the design tokens
...
Now you can use the tokens by typing ds and continuing the dot notation with the token name followed by the token value the token value. For instance, `ds.Breakpoint.small`.
