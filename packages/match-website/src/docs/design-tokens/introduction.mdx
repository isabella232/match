...
Now you can use the tokens by typing ds and continuing the dot notation with the token name and token value. For instance, `ds.breakpoint.small.mediaQuery` or `ds.swatch.baseBlue.color`.
...
- JavaScript: `breakpoint.small.mediaQuery`
