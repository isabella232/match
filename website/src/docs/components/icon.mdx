...
There are currently 3 supported icon packages. `@twilio-labs/match/icons/twilio`, `@twilio-labs/match/icons/sendgrid`, and the universal `@twilio-labs/match/icons/product`. Icons are imported individually from their respective packages.
...
| title?      | string   | null     | Accessibility text provided to screenreaders.                                                                            |
